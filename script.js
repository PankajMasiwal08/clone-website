...
function footer(){
  ...
  document.querySelector(".footer-elem").addEventListener("mouseenter", function () {
  ...
  document.querySelector(".footer-elem").addEventListener("mouseleave", function () {
    gsap.to("#footer h1 span", {
      opacity: 1,
      stagger: 0.1,
      delay: 0.35,
